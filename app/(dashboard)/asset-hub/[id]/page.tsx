    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {asset.repo_url && (
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface px-4 py-2.5 text-sm font-medium text-text hover:border-accent/50 transition-colors"
        >
